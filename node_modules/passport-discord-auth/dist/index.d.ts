import { StrategyOptions as StrategyOptions$1, StrategyOptionsWithRequest, Strategy as Strategy$1, VerifyCallback } from 'passport-oauth2';
...
type SingleScopeType = `${Scope}`;
type ScopeType = SingleScopeType[];
type MergedOAuth2StrategyOptions = StrategyOptions$1 | StrategyOptionsWithRequest;
interface StrategyOptions extends Omit<MergedOAuth2StrategyOptions, 'clientID' | 'clientSecret' | 'scope' | 'authorizationURL' | 'tokenURL'> {
    /**
...
interface Profile extends Omit<passport.Profile, 'username'>, DiscordUser {
    /**
...
type VerifyFunction = (accessToken: string, refreshToken: string, profile: Profile, verified: VerifyCallback) => void;
 ...
 */
declare class Strategy extends Strategy$1 {
    name: string;
    private scope;
    private scopeDelay;
    private fetchScopeEnabled;
    /**
     * Passport strategy for authenticating with Discord using the OAuth 2.0 API.
     ...
     */
    fetchScope(scope: SingleScopeType, accessToken: string, cb: (err?: Error | null, data?: unknown) => void): void;
    /**
     * Return extra parameters to be included in the authorization request.
     * @param options The options.
     * @returns The extra parameters.
     */
    authorizationParams(options: AuthorizationParams): AuthorizationParams & Record<string, unknown>;
}

export { type DiscordAccount, type DiscordApplication, type DiscordEmoji, type DiscordIntegration, type DiscordRole, type DiscordRoleTag, type DiscordSticker, type DiscordUser, type DiscordWelcomeScreen, type DiscordWelcomeScreenChannel, type Profile, type ProfileConnection, type ProfileGuild, Scope, type ScopeType, type SingleScopeType, Strategy, type StrategyOptions };
